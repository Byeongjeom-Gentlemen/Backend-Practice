...
public class CommentRepositoryImpl implements CommentRepositoryCustom {
    ...
    @Override
    public Slice<SimpleCommentResponseDto> findByCommentIdLessThanOrderByCreatedAtDesc(Long lastCommentId, Long boardId, Pageable pageable) {

        List<SimpleCommentResponseDto> results = queryFactory
                .select(Projections.constructor(SimpleCommentResponseDto.class,
                        comment.commentId,
                        comment.content,
                        comment.user,
                        comment.createdDate,
    ...
    // 무한 스크롤 방식 처리하는 메서드
    private Slice<SimpleCommentResponseDto> checkLastPage(Pageable pageable, List<SimpleCommentResponseDto> result) {
