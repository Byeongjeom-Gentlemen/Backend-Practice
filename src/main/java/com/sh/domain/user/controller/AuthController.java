...
public class AuthController {
    ...
    // Access Token 재발급
    @Operation(summary = "Access Token 재발급 API", description = "Request Header에 있는 Refresh Token 값으로 Access Token을 재발급 받는 API 입니다.")
    ...
    public ResponseEntity<TokenDto> accessTokenReIssue(HttpServletRequest request) {
        ...
        return ResponseEntity.ok()
                .body(authService.accessTokenReIssue(refreshToken));
    }
}
