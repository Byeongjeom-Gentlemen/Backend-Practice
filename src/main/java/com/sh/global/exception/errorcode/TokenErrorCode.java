...
public enum TokenErrorCode implements ErrorCode {
    ...
    EXPIRED_ACCESS_TOKEN(HttpStatus.FORBIDDEN, "T_004", "만료된 토큰으로 유효하지 않은 토큰 정보입니다. 재발급이 필요합니다."),
    ...
    EXPIRED_REFRESH_TOKEN(HttpStatus.FORBIDDEN, "T_010", "Refresh Token이 만료되었습니다. 재 로그인이 필요합니다.");
